...
// Further Modified for use case specific requirements by: Theo Gainey <https://github.com/theogainey> 
...
class Renderer {
  ...
  image(href: string, title: string, text: string) {
    ...
    let out = `<div class="cmp-image-container"><img class="cmp-image" loading="lazy" src="${href}" alt="${text}"`;
    if (title) {
      out += ` title="${title}"`;
    }
